    ...
    specs: [
      {
        ...
        options: [
          ...
          { id: 'sp2s_pod_bundle_o06', name: '芭樂', stock: 1003, priceDelta: 0 },
          ...
          { id: 'sp2s_pod_bundle_o25', name: '利槟納（黑佳麗）', stock: 739, priceDelta: 0 },
          { id: 'sp2s_pod_bundle_o26', name: '冰礦泉茉莉', stock: 982, priceDelta: 0 },
          { id: 'sp2s_pod_bundle_o27', name: '冰礦泉', stock: 1054, priceDelta: 0 },
          { id: 'sp2s_pod_bundle_o28', name: '凍檸冰橙', stock: 890, priceDelta: 0 },
          ...
          { id: 'sp2s_pod_bundle_o33', name: '超柔菸草', stock: 862, priceDelta: 0 }
        ]
      }
    ]
  },
    ...
    specs: [
      {
        ...
        options: [
          ...
          { id: 'lana_pod_o02', name: '冰紅茶', stock: 1091, priceDelta: 0 },
          { id: 'lana_pod_o03', name: '深海冰泉', stock: 1006, priceDelta: 0 },
          { id: 'lana_pod_o04', name: '西瓜冰', stock: 987, priceDelta: 0 },
          { id: 'lana_pod_o05', name: '老冰棍', stock: 1048, priceDelta: 0 },
          { id: 'lana_pod_o06', name: '芒果', stock: 1108, priceDelta: 0 },
          { id: 'lana_pod_o07', name: '漿果葡萄柚', stock: 832, priceDelta: 0 },
          { id: 'lana_pod_o08', name: '綜合水果', stock: 1019, priceDelta: 0 },
          { id: 'lana_pod_o09', name: '沙士紅酒', stock: 1200, priceDelta: 0 },
          { id: 'lana_pod_o10', name: '鳳梨', stock: 876, priceDelta: 0 },
          { id: 'lana_pod_o11', name: '草莓牛奶', stock: 1142, priceDelta: 0 },
          { id: 'lana_pod_o12', name: '冰橙', stock: 795, priceDelta: 0 },
          { id: 'lana_pod_o13', name: '冰藍莓', stock: 942, priceDelta: 0 },
          { id: 'lana_pod_o14', name: '冰荔枝', stock: 1187, priceDelta: 0 },
          { id: 'lana_pod_o15', name: '青蘋果', stock: 731, priceDelta: 0 },
          { id: 'lana_pod_o16', name: '樹梅果', stock: 864, priceDelta: 0 },
          { id: 'lana_pod_o17', name: '水蜜桃', stock: 1124, priceDelta: 0 },
          { id: 'lana_pod_o18', name: '雪碧', stock: 758, priceDelta: 0 },
          { id: 'lana_pod_o19', name: '冰可樂', stock: 1169, priceDelta: 0 },
          { id: 'lana_pod_o20', name: '鐵觀音', stock: 821, priceDelta: 0 },
          { id: 'lana_pod_o21', name: '綠豆', stock: 739, priceDelta: 0 },
          { id: 'lana_pod_o22', name: '奇異果', stock: 1195, priceDelta: 0 },
          { id: 'lana_pod_o23', name: '多汁葡萄', stock: 903, priceDelta: 0 },
          { id: 'lana_pod_o24', name: '烏龍茶', stock: 781, priceDelta: 0 },
          { id: 'lana_pod_o25', name: '薄荷口香糖', stock: 965, priceDelta: 0 },
          { id: 'lana_pod_o26', name: '芭樂', stock: 1076, priceDelta: 0 },
          { id: 'lana_pod_o27', name: '草莓西瓜', stock: 1183, priceDelta: 0 },
          { id: 'lana_pod_o28', name: '蔓越莓汁', stock: 746, priceDelta: 0 },
          { id: 'lana_pod_o29', name: '哈密瓜', stock: 1151, priceDelta: 0 },
          { id: 'lana_pod_o30', name: '龍井', stock: 788, priceDelta: 0 },
          { id: 'lana_pod_o31', name: '彩虹糖', stock: 962, priceDelta: 0 },
          { id: 'lana_pod_o32', name: '芒果百香果', stock: 1064, priceDelta: 0 }
        ]
      }
    ]
  },
    ...
    specs: [
      {
        ...
        options: [
          ...
          { id: 'mohoo_tokyo_box_o11', name: '（涼版）水蜜桃', stock: 1058, priceDelta: 0 },
          ...
          { id: 'mohoo_tokyo_box_o45', name: '（極涼版）NEW！芒果奶昔', stock: 888, priceDelta: 0 },
          { id: 'mohoo_tokyo_box_o46', name: '（極涼版）NEW！綜合野莓', stock: 936, priceDelta: 0 }
        ]
      }
    ]
  },
